    ...
    return (
        <div className={styles.projectmain} style={{ borderColor: currentTheme.accent, borderRadius: id % 2 === 0 ? '50px 0 0 0' : '0 0 50px 0' }}>
            <div className={styles.projectContent}>
                ...
                <Link href='/work'><a className={styles.cta2} style={{ background: 'transparent', border: `2px solid ${currentTheme.contrastText}`, color: currentTheme.contrastText }}>Voir </a></Link>
            </div>
        </div>
    )
}
