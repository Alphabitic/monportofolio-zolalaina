...
const Education = ({ currentTheme }) => {
    return (
        <div className={styles.educationWrapper}>
            ...
            {/* <div style={{ textAlign: 'center', paddingBottom: '2rem' }}><Link href="/#about"><a className={styles.cta3} style={{ background: 'transparent', border: `2px solid ${currentTheme.text}`, color: currentTheme.text }}>{ctaTexts.educationCTA} <span>&gt;</span></a></Link></div> */}
